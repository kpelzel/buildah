...
func init() {
	...
	rootCmd.PersistentFlags().BoolVar(&globalFlagResults.NoUIDMap, "no-uidmap", false, "does not use uidmap tools")
...
func before(cmd *cobra.Command, args []string) error {
	...
	unshare.MaybeReexecUsingUserNamespace(false, globalFlagResults.NoUIDMap)
	return nil
}
